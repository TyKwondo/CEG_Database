...
class Data_Flows(models.Model):
    ...
    main_name = models.CharField(max_length=100, default='')
    main_port = models.CharField(max_length=20, default='')
    main_address = models.CharField(max_length=10, default='')
    subordinate_name = models.CharField(max_length=50, default='')
    subordinate_port = models.CharField(max_length=20, default='')
    subordinate_address = models.CharField(max_length=10, default='')
    def __str__(self):
